...
var TEST_EN = {
  ...
  ui: {
    ...
    // ---- the six challenges ----
    hubH:        'Discover yourself',
    hubSub:      'Six challenges. Start with any one.',
    ...
    authDialogSub:'Enter your email and a password of at least 6 characters.',
    authPassHint: 'At least 6 characters.',
    authClose:   'Close',
    ...
    authConfirm: 'We sent a confirmation code to your email.',
    authCodeH: 'Confirm your email',
    authCodeSub: 'Enter the 6-digit code we sent to your email.',
    ...
    profileNote: 'For statistics only; they do not affect your result. Every field is required; choose Later to start the challenge another time.',
    profileFirst: 'First name', profileLast: 'Last name', profileCountry: 'Country',
    profileRegion: 'Region', profileDistrict: 'District', profileSchool: 'School',
    profileGrade: 'Grade', profilePlaceholder: 'Enter this',
    profilePickRegion: 'Choose a region', profilePickDistrict: 'Choose a district or city',
    profilePickGrade: 'Choose a grade', profilePickSchool: 'Choose a school',
    ...
    errEmailTypo:      'That address looks misspelt. Did you mean %1?',
    ...
    errResendWait:     'You can ask for a new code in 1 minute.',
